...
function Zone8() {
    ...
    async function GET() {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            localStorage.setItem(`Z${i +36 }`, JSON.stringify(result));
        }
    }
        ...
        <div className="ZoneDiv">
            {loading ?
                ...
                <div className="TableDiv1">
                    {show ?
                        <h2 className="ZoneHeading">Click To Get Zone 8 Winners </h2>
                        :
                        <h2 className="ZoneHeading"> Zone 8 Winners are </h2>
                    }
                    {confettiActive ?
                        <div>
                    ...
                    <div className="buttons">
                        <div>
                            <Button variant="info" style={{ fontWeight: "700",border:"1px solid black" }} onClick={GET}>Zone 8 Winners</Button>{' '}
                        </div>
                        {save ?
                            <div>
