...
function Zone8() {
    ...
    async function GET() {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            localStorage.setItem(`WZ${i + 22}`, JSON.stringify(result));
        }
    }
    ...
    async function SaveData() {
        try {
            for (const item of state) {
                ...
                const response = await fetch(`http://localhost:5000/WaterForth/Zone8/${SR_NO}`, {
                    method: "POST",
        ...
        <div className="ZoneDiv">
            ...
            {loading ?
                ...
                <div className="TableDiv1">
                    {show ?
                        <h2 className="ZoneHeading">Click To Get Zone8 Winners </h2>
                        :
                    ...
                    <div className="buttons">
                        <div>
                            <Button variant="warning" style={{ fontWeight: "700" }} onClick={GET}>Zone 8 Winners</Button>{' '}
                        </div>
                        {save ?
                            <div>
