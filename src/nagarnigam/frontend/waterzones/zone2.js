...
function Zone2() {
    ...
    async function GET() {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            localStorage.setItem(`WZ${i + 4}`, JSON.stringify(result));
        }
    }
    ...
    async function SaveData() {
        try {
            for (const item of state) {
                ...
                const response = await fetch(`http://localhost:5000/WaterForth/Zone2/${SR_NO}`, {
                    method: "POST",
        ...
        <div className="ZoneDiv">
            ...
            {loading ?
                ...
                <div className="TableDiv1">
                    {show ?
                        <h2 className="ZoneHeading">Click To Get Zone2 Winners </h2>
                        :
                        <h2 className="ZoneHeading"> Zone 2 Winners are </h2>
                    }
                    {confettiActive ?
                        <div>
                    ...
                    <div className="buttons">
                        <div>
                            <Button variant="info" style={{ fontWeight: "700" }} onClick={GET}>Zone 2 Winners</Button>{' '}
                        </div>
                        {save ?
                            <div>
