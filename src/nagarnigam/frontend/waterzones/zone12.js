...
function Zone12() {
    ...
    async function GET() {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            localStorage.setItem(`WZ${i + 34}`, JSON.stringify(result));
        }
    }
    ...
    async function SaveData() {
        try {
            for (const item of state) {
                ...
                const response = await fetch(`http://localhost:5000/WaterForth/Zone12/${SR_NO}`, {
                    method: "POST",
        ...
        <div className="ZoneDiv">
            ...
            {loading ?
                ...
                <div className="TableDiv1">
                    {show ?
                        <h2 className="ZoneHeading">Click To Get Zone12 Winners </h2>
                        :
                    ...
                    <div className="buttons">
                        <div>
                            <Button variant="warning" style={{ fontWeight: "700" }} onClick={GET}>Zone 12 Winners</Button>{' '}
                        </div>
                        {save ?
                            <div>
