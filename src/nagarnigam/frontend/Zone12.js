...
function Zone12() {
  ...
  async function GET() {
    ...
    for (let i = 0; i < 5; i++) {
        ...
        localStorage.setItem(`Z${i + 56}`, JSON.stringify(result));
    }
}
async function SaveData() {
    try {
        ...
        navigate("/Property/Forth/Zone13    ");
    ...
    return (
        ...
        {loading ?
            ...
            <div className="TableDiv1">
                {show ?
                    <h2 className="ZoneHeading">Click To Get Zone 12 Winners </h2>
                    :
                    <h2 className="ZoneHeading"> Zone 12 Winners are </h2>
                }
                   {confettiActive?
    <div>
    ...
    :null
                ...
                <div className="buttons">
                    <div>
                        <Button variant="info" style={{ fontWeight: "700",border:"1px solid black" }} onClick={GET}>Zone 12 Winners</Button>{' '}
                    </div>
                    {save ?
                        <div>
